...
d3.csv("data/cf_data.csv", function(error, flights) {
  ...
  var nestByDate = d3.nest()
      .key(function(d) { return  +d3.round(d.date ,3); });
  ...
  flights.forEach(function(d, i) {
    ...
    d.support = +d.support;
    d.confidence = +d3.round(d.confidence ,3);
  });
  ...
  var flight = crossfilter(flights),
      ...
      support = flight.dimension(function(d) { return d.support; }),
      supports = support.group(function(d) { return Math.floor(d / 10) * 10; }),
      confidence = flight.dimension(function(d) { return d.confidence; }),
